...
class Settings(BaseSettings):
    ...
    ONTOLOGY_PATH: str = str(PROJECT_ROOT / "src" / "app" / "pipeline" / "ingestion" / "graph" / "ontology.json")
    ...
    MAX_CONCURRENT_GENERATION_TASKS: int = 2  # Low concurrency for heavy LLM inference
    MAX_CONCURRENT_EMBEDDING_TASKS: int = 15  # High concurrency for fast dense embeddings
